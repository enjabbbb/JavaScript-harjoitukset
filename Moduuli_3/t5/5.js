...
const sectionPicture = document.getElementById("pictures");
sectionPicture.innerHTML = "";
for (let i = 0; i < picArray.length; i++){
 ...
 const heding = document.createElement("h2");
 heding.textContent = picture.title;
 ...
 article.appendChild(heding);
 article.appendChild(figure);
 article.appendChild(description);

 sectionPicture.appendChild(article);
}
